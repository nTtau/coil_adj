...
#coilsvtk = LegacyVTKReader(FileNames=['/home/ssharpe/FIN_MAG_CODE/MAG_FIELD_CALC/Example_files/vtk_files/coils.vtk'])

# create a new 'Legacy VTK Reader'
#radvtk = LegacyVTKReader(FileNames=['/home/ssharpe/FIN_MAG_CODE/MAG_FIELD_CALC/Example_files/vtk_files/rad.vtk'])
...
b_totcsv = CSVReader(FileName=['/home/ssharpe/FIN_MAG_CODE/MAG_FIELD_CALC/Example_outputs/Magnetic_field_parallel_output/B_tot.csv'])
...
# save screenshot
SaveScreenshot('Tokamak_half.png', renderView2, ImageResolution=[1135, 1065])
...
# save screenshot
SaveScreenshot('Tokamak_full.png', renderView1, ImageResolution=[1135, 1065])
